        ...
        \begin{sol}
          \begin{proof} $\frac{\D
            ...
            \begin{enumerate}[label=(\arabic*)]
              ...
              \item since the values of $\beta$ are being muliplied with themselves, this means $\beta^T\beta = \beta^2$
              \item using power rule we can determine that $\frac{\D
            f}{\D \beta}$ of $\beta^2 = 2\beta$
