...
% solution goes here
\begin{sol}
	On the previous homework I chose LSTAT and MEDV, check figure \ref{img1} for the corresponding graph.
\end{sol}
...
% solution goes here
\begin{sol}
	At $\lambda = 0$ the RMSE $= 1.6229250958730225 * 10^{-13}$
\end{sol}
...
\img<img1>[.65]{BestFit Graph}{./media/RidgeRegression.png}
